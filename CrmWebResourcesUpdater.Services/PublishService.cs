...
//            crmWebResourceUpdaterClient = new CrmWebResourcesUpdaterClient();
//        }
...
//            var webResources = await crmWebResourceUpdaterClient.RetrieveWebResourcesAsync(selectedConnection, webResourceNames);
//            return webResources;
//        }
...
//                //TODO: Make async
//                if (await crmWebResourceUpdaterClient.IsWebResourceExistsAsync(connectionDetail, webresourceName))
//                {
...
//            var solution = await crmWebResourceUpdaterClient.RetrieveSolutionAsync(selectedConnection, selectedConnection.SelectedSolution.SolutionId);
