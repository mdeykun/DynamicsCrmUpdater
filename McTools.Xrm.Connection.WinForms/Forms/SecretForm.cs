...
namespace McTools.Xrm.Connection.WinForms
{
    ...
    public partial class SecretForm : Form
    {
        ...
        /// </summary>
        public SecretForm(string connectionName)
        {
            InitializeComponent();

            lblConnectionName.Text = connectionName;//detail.ConnectionName;
        }
        ...
        /// Obtient le secret
        /// </summary>
        public SecureString ClientSecret => clientSecret.ToSecureString();
